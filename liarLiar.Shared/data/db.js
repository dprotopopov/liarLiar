...
(function() {
    ...
    var endpointSelector = new DevExpress.EndpointSelector(liarLiar.config.endpoints);
    var serviceConfig = $.extend(true, {}, liarLiar.config.services, {
        db: {
    ...
    liarLiar.db = new DevExpress.data.ODataContext(serviceConfig.db);
